...
// 🚀 LIMIT products (huge impact)
$bestStmt = $pdo->prepare("SELECT * FROM products WHERE is_bestseller = 1 ORDER BY created_at DESC LIMIT 12");
$bestStmt->execute();
...
<body class="font-sans bg-white transition-colors duration-300">
                    ...
                    <?php foreach ($slides as $slide): ?>
                        <a href="<?php echo htmlspecialchars($slide['link_url']); ?>"
                            ...
                            <picture class="w-full h-full">
                                ...
                                <!-- Mobile Image -->
                                <img src="<?php echo htmlspecialchars($slide['image_url_mobile']); ?>" loading="lazy"
        ...
        <div
            ...
            <?php foreach ($promos as $promo): ?>
                <a href="<?php echo htmlspecialchars($promo['link_url']); ?>"
                    ...
                    <img src="<?php echo htmlspecialchars($promo['bg_image']); ?>" loading="lazy"
            ...
            <?php foreach ($bestsellers as $product): ?>
                ...
                <div
                    ...
                    <div class="aspect-square w-full mb-4 overflow-hidden rounded-xl bg-gray-50 dark:bg-gray-800 relative">
                        <img src="<?php echo htmlspecialchars($product['image_path']); ?>" loading="lazy"
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div
            class="relative w-full h-[140px] md:h-[220px] overflow-hidden rounded-[20px] shadow-md border border-gray-100 dark:border-gray-800">
